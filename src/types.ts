/**
 * EntitlementTissue — Type Definitions
...
// Tissue Identity
export const TISSUE_ID = 'TIS-AI-ENTITLEMENT_TISSUE-v0.1.0' as const;
export const TISSUE_HASH = '46731e1d' as const;
export const CLASSIFICATION = 'Structural Boundary' as const;
export const COMPOSED_CELLS = ['CEL-AI-COGNITIVE_CELL', 'CEL-POLICYEVAL', 'CEL-AUDITLOG'] as const;
