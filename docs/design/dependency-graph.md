# EntitlementTissue — Dependency Graph
...
| CEL-POLICYEVAL | Cell | Yes |
| CEL-AUDITLOG | Cell | Yes |

### 2. Downstream Consumers
- Organ layer components that require structural boundary coordination
...
class EntitlementTissueBinder {
  ...
  validateBindings(): BindingValidationResult {
    const required = ["CEL-AI-COGNITIVE_CELL", "CEL-POLICYEVAL", "CEL-AUDITLOG"];
